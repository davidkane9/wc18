...
FIFA has made several official player lists available, (in)conveniently changing the format each time. For this exercise, I use the one from early June. The [tabulizer package](https://CRAN.R-project.org/package=tabulizer) makes extracting information from tables included in a PDF document relatively easy. 
